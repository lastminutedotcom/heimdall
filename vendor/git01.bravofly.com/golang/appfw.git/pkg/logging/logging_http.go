...
import (
	...
	"git01.bravofly.com/golang/appfw.git/pkg/tracing"
)
...
// ServeHTTP implements http.Handler interface using the logger to get the reponse from the application handler
